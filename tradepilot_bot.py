...
<div class="section-header"><div class="section-letter">C</div><div class="section-text"><h2>VPS Gratuit Amazon AWS</h2><p>Serveur Windows cloud — 4 etapes</p></div></div>
<div class="alert warn"><div class="alert-label">ATTENTION</div><div class="alert-text">Utilise UNIQUEMENT le type t2.micro. Tous les autres types sont factures immediatement.</div></div>

<div class="sub-header">C.1 — Creer ton compte AWS | aws.amazon.com</div>
<div class="step"><div class="step-num">1</div><div class="step-content"><div class="step-title">Ouvrir aws.amazon.com</div><div class="step-line">Cliquer sur "Creer un compte AWS" en haut a droite.</div></div></div>
<div class="step"><div class="step-num">2</div><div class="step-content"><div class="step-title">Remplir les informations</div><div class="step-line">Email | Nom du compte (ex: TradePilot) | Mot de passe | Continuer</div></div></div>
<div class="step"><div class="step-num">3</div><div class="step-content"><div class="step-title">Type de compte</div><div class="step-line">Selectionner "Personnel" — remplir prenom, nom, telephone, adresse.</div></div></div>
<div class="step"><div class="step-num">4</div><div class="step-content"><div class="step-title">Carte bancaire</div><div class="step-line">Entrer les infos de carte. Une charge de 1$ apparait puis est remboursee — simple verification.</div></div></div>
<div class="step"><div class="step-num">5</div><div class="step-content"><div class="step-title">Verification SMS</div><div class="step-line">Choisir "Message texte (SMS)" | Code recu | Continuer</div></div></div>
<div class="step"><div class="step-num">6</div><div class="step-content"><div class="step-title">Plan Gratuit</div><div class="step-line">Selectionner "Gratuit (Free)" | "Terminer l'inscription" | "Acceder a la console"</div></div></div>
<div class="photo">AJOUTER CAPTURE — Compte AWS cree</div>
<div class="alert ok"><div class="alert-label">OK</div><div class="alert-text">Compte AWS cree — tu es dans la console Amazon.</div></div>

<div class="sub-header">C.2 — Lancer le serveur Windows | Console AWS > EC2</div>
<div class="step"><div class="step-num">1</div><div class="step-content"><div class="step-title">Aller dans EC2</div><div class="step-line">Taper "EC2" dans la barre de recherche → cliquer sur le resultat.</div></div></div>
<div class="step"><div class="step-num">2</div><div class="step-content"><div class="step-title">Lancer une instance</div><div class="step-line">Cliquer sur le bouton orange "Lancer une instance".</div></div></div>
<div class="step"><div class="step-num">3</div><div class="step-content"><div class="step-title">Nommer le serveur</div><div class="step-line">Dans le champ Nom → taper : TradePilot-Bot</div></div></div>
<div class="step"><div class="step-num">4</div><div class="step-content"><div class="step-title">Image Windows</div><div class="step-line">Cliquer "Windows" → "Microsoft Windows Server 2022 Base" → verifier "Free tier eligible"</div></div></div>
<div class="step"><div class="step-num">5</div><div class="step-content"><div class="step-title">Type t2.micro — UNIQUEMENT CE TYPE</div><div class="step-line">Selectionner "t2.micro" → "Free tier eligible". Ne JAMAIS changer ce type.</div></div></div>
<div class="step"><div class="step-num">6</div><div class="step-content"><div class="step-title">Paire de cles</div><div class="step-line">"Creer une paire de cles" → Nom: tradepilot-key → RSA → .pem → Creer. GARDER CE FICHIER.</div></div></div>
<div class="step"><div class="step-num">7</div><div class="step-content"><div class="step-title">Reseau</div><div class="step-line">Cocher : Autoriser RDP | HTTP | HTTPS</div></div></div>
<div class="step"><div class="step-num">8</div><div class="step-content"><div class="step-title">Lancer</div><div class="step-line">"Lancer l'instance" → attendre 3-5 min → statut "En cours d'execution"</div></div></div>
<div class="photo">AJOUTER CAPTURE — Instance EC2 en cours d'execution</div>

<div class="sub-header">C.3 — Recuperer le mot de passe | Instance AWS</div>
<div class="step"><div class="step-num">1</div><div class="step-content"><div class="step-title">Ouvrir l'instance</div><div class="step-line">Cliquer sur l'ID de l'instance (ex: i-0abc123...)</div></div></div>
<div class="step"><div class="step-num">2</div><div class="step-content"><div class="step-title">Se connecter > Client RDP</div><div class="step-line">Cliquer "Se connecter" → onglet "Client RDP"</div></div></div>
<div class="step"><div class="step-num">3</div><div class="step-content"><div class="step-title">Dechiffrer le mot de passe</div><div class="step-line">"Obtenir le mot de passe" → "Parcourir" → tradepilot-key.pem → "Dechiffrer"</div></div></div>
<div class="step"><div class="step-num">4</div><div class="step-content"><div class="step-title">Noter les identifiants</div><div class="step-line">Copier : Nom DNS public | Utilisateur: Administrator | Mot de passe (long, copier en entier)</div></div></div>
<div class="photo">AJOUTER CAPTURE — Identifiants visibles</div>

<div class="sub-header">C.4 — Connexion Bureau a distance | mstsc</div>
<div class="step"><div class="step-num">1</div><div class="step-content"><div class="step-title">Ouvrir mstsc</div><div class="step-line">Windows + R → mstsc → Entree</div></div></div>
<div class="step"><div class="step-num">2</div><div class="step-content"><div class="step-title">Entrer l'adresse</div><div class="step-line">Coller le Nom DNS public → Connexion</div></div></div>
<div class="step"><div class="step-num">3</div><div class="step-content"><div class="step-title">Identifiants</div><div class="step-line">Utilisateur: Administrator | Mot de passe: (celui copie) | OK</div></div></div>
<div class="step"><div class="step-num">4</div><div class="step-content"><div class="step-title">Chargement</div><div class="step-line">Attendre 30-60 secondes → le Bureau Windows du serveur apparait.</div></div></div>
<div class="photo">AJOUTER CAPTURE — Bureau Windows AWS visible</div>
<div class="alert ok"><div class="alert-label">OK</div><div class="alert-text">Connecte au serveur AWS. Toutes les etapes suivantes se font SUR CE SERVEUR.</div></div>
...
<div class="section-header" style="border-color:#00C97A;"><div class="section-letter" style="background:#00C97A;">C</div><div class="section-text"><h2>Deroulement de la session</h2><p>Ce qui se passe de A a Z</p></div></div>
...
<div class="section-header" style="border-color:#00C97A;"><div class="section-letter" style="background:#00C97A;">D</div><div class="section-text"><h2>FAQ</h2><p>Questions frequentes</p></div></div>
