...
async def on_ready():
    ...
    welcome_ch = guild.get_channel(1521812461005570099)
    if welcome_ch:
        async for msg in welcome_ch.history(limit=10):
            ...
            embed_welcome = discord.Embed(
                title="👋 Bienvenue sur TradePilot !",
                description=(
                    "Bienvenue sur le serveur officiel **TradePilot** ! ⚡\n\n"
                    "TradePilot automatise tes signaux Telegram → MT4 & MT5.\n\n"
                    "**Pour commencer :**\n"
                    "→ Lis **#règles-et-infos** pour voir nos offres\n"
                    "→ Consulte **#guide-débutant** si tu débutes\n"
                    "→ Pose tes questions dans **#général-trading**\n"
                    "→ Ouvre un ticket dans **#ouvrir-un-ticket** pour acheter\n\n"
                    "On est content de t'avoir parmi nous ! 🚀"
                ),
                color=0xF5B830
            )
            embed_welcome.set_footer(text="TradePilot — Automatisation MT4 & MT5")
